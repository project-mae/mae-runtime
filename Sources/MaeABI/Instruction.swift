...
public let instructionLookupTable: [Instruction?] = [
  ...
  .Swap(first: .A, second: .A), .Swap(first: .A, second: .B), .Swap(first: .A, second: .C),
  .Swap(first: .A, second: .D),
  .Swap(first: .B, second: .A), .Swap(first: .B, second: .B), .Swap(first: .B, second: .C),
  .Swap(first: .B, second: .D),
  .Swap(first: .C, second: .A), .Swap(first: .C, second: .B), .Swap(first: .C, second: .C),
  .Swap(first: .C, second: .D),
  .Swap(first: .D, second: .A), .Swap(first: .D, second: .B), .Swap(first: .D, second: .C),
  ...
  .Equal(first: .A, second: .A), .Equal(first: .A, second: .B), .Equal(first: .A, second: .C),
  .Equal(first: .A, second: .D),
  .Equal(first: .B, second: .A), .Equal(first: .B, second: .B), .Equal(first: .B, second: .C),
  .Equal(first: .B, second: .D),
  .Equal(first: .C, second: .A), .Equal(first: .C, second: .B), .Equal(first: .C, second: .C),
  .Equal(first: .C, second: .D),
  .Equal(first: .D, second: .A), .Equal(first: .D, second: .B), .Equal(first: .D, second: .C),
  ...
  // 1100 11 <2 address>
  .ConditionalJump(address: .A), .ConditionalJump(address: .B), .ConditionalJump(address: .C),
